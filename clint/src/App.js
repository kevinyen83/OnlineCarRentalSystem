                    ...
                    <div className="popup-form">
                        ...
                        <div className="form-container">
                            <div className="form-header">
                                ...
                                <div className="form-header-close-popup" onClick={checkout}>Close</div>
                            </div>
                            ...
                            <div className="form-footer">
                                <div className="form-footer-item">
                                    <div className="form-footer-price"><h3>Total Price: ${totalPrice.toFixed(2)}</h3></div>
                                </div>
                                <div className="form-footer-item">
                                    <div className="form-footer-bond"><h3>Bond: ${bondValue}</h3></div>                        
                                </div>
                                <div className="form-footer-item">
                                    <div></div>
                                </div>
                                <div className="form-footer-item">
                                    <div className="form-footer-btn" type="button" onClick={checkout}>Continue Selection</div>
                                </div>
                                <div className="form-footer-item">
                                    <div className="form-footer-btn" type="submit" onClick={bookingCar}>Booking</div>     
                                </div>
                            </div>
                        </div>
                    </div>     
